...
int main(int argc, char **argv)
{
    ...
    while ((c = getopt (argc, argv, "ao:i:")) != -1)
    {
        switch (c)
        {
            ...
            case '?':
                ...
                //fprintf (stderr, "Option -%o: Specify output file.\n", optopt);
                else if (optopt == 'i')
                printf ("Option -%c: Specify input file.\n", optopt);
                //fprintf (stderr, "Option -%c: Specify input file.\n", optopt);
    ...
    printf ("outFileName = %s, inFileName = %s\n", outFileName, inFileName);
    ...
    {
        printf ("Specify input and output file using -i and -o");
        return 1;
    }
    ...
    DFU_tsImageInfo  sImageInfo  = fNewImageInfo();
    ...
    int   r   = ihex_mem_copy(hexrec, bProgDatBuf, max, IHEX_WIDTH_8BIT, IHEX_ORDER_BIGENDIAN);
    ...
    //memcpy(&sImageInfo.sOutputFileName, outFileName, sizeof(outFileName));
