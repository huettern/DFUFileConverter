...
#define DFU_DEFAULT_FILENAME "output.dfu"
...
=============================================================================*/
DFU_tsImageInfo fNewImageInfo (void)
{
    ...
    memcpy(tsInfo.sOutputFileName, DFU_DEFAULT_FILENAME , sizeof(DFU_DEFAULT_FILENAME ));
